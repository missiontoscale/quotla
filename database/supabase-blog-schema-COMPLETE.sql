-- ================================================================
-- QUOTLA BLOG SYSTEM - COMPLETE DATABASE SCHEMA
-- ================================================================
-- This file contains EVERYTHING needed for the blog system:
-- - Base blog_posts table creation
...
-- ================================================================
-- PART 1: CREATE BASE BLOG_POSTS TABLE
-- ================================================================
...
-- ================================================================
-- PART 2: ADD ADMIN MANAGEMENT FIELDS
-- ================================================================
...
-- ================================================================
-- PART 3: BLOG POST LIKES/REACTIONS SYSTEM
-- ================================================================
...
-- ================================================================
-- PART 4: SOCIAL SHARING TRACKING
-- ================================================================
...
-- ================================================================
-- PART 5: BLOG POST VIEW TRACKING
-- ================================================================
...
-- ================================================================
-- PART 6: DISQUS INTEGRATION SETTINGS
-- ================================================================
...
-- ================================================================
-- PART 7: ENHANCED BLOG POST METADATA
-- ================================================================
...
DROP POLICY IF EXISTS "Admins can update their own posts" ON blog_posts;
DROP POLICY IF EXISTS "Senior admins can delete any post" ON blog_posts;
DROP POLICY IF EXISTS "Admins can delete their own posts" ON blog_posts;
...
-- ================================================================
-- PART 10: HELPER FUNCTIONS FOR BLOG ANALYTICS
-- ================================================================
...
-- Next steps:
--
-- 1. Set yourself as senior admin:
--    UPDATE profiles SET is_admin = true, senior_admin = true
--    WHERE email = 'chibuzordev@gmail.com';
--
-- 2. (Optional) Update Disqus shortname:
--    UPDATE blog_settings SET setting_value = 'your-actual-disqus-shortname'
--    WHERE setting_key = 'disqus_shortname';
--
-- 3. Import your blog posts using the CMS:
--    - Go to /admin/blog/import
--    - Copy content from blogs-to-import.json
--    - Paste and import
--
-- ================================================================
