...
export default function DownloadDropdown({ type, data, profile }: DownloadDropdownProps) {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 md:left-auto md:right-0 bottom-full mb-2 md:bottom-auto md:top-full md:mt-2 w-48 rounded-md shadow-lg bg-primary-800 ring-1 ring-primary-600 z-50">
          <div className="py-1" role="menu">
            <button
              onClick={() => handleExport('pdf')}
              className="block w-full text-left px-4 py-3 md:py-2 text-sm text-primary-200 hover:bg-primary-600/80 min-h-[44px] md:min-h-0"
              role="menuitem"
            >
              PDF Document
            </button>
